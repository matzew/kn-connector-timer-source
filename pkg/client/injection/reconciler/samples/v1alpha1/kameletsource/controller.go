...
import (
	...
	versionedscheme "knative.dev/kamelet-source/pkg/client/clientset/versioned/scheme"
	client "knative.dev/kamelet-source/pkg/client/injection/client"
...
const (
	defaultControllerAgentName = "kameletsource-controller"
	defaultFinalizerName       = "kameletsources.samples.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	kameletsourceInformer := kameletsource.Get(ctx)

	lister := kameletsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "samples.knative.dev.KameletSource"),
	)
